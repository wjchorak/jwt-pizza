...
| Order pizza                                         | menu.tsx <br/> payment.tsx | `[GET] /api/order/menu` <br/> `[GET] /api/franchise?page=${page}&limit=${limit}&name=${nameFilter}` <br/> `[GET] /api/user/me` <br/> `[POST] /api/order` |              |
| Verify pizza                                        |                    |                   |              |
| View profile page                                   |                    |                   |              |
